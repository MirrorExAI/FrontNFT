      ...
      <div class="md:w-3/5 w-10/12 h-full flex items-center justify-evenly">
        ...
        <div class="z-[999] pt-12 pb-10 md:w-96 w-full  rounded-lg flex flex-col justify-between box-border">
          <div>
            ...
            <div class="mb-9">
              <p class="text-center text-6xl font-bold">{{ $GIN_VUE_ADMIN.appName }}</p>
              <p class="text-center text-sm font-normal text-gray-500 mt-2.5">I dont want to be the next Michael Jordan, I only want to be Kobe Bryant.
              </p>
            </div>
            <el-form
              ref="loginForm"
            ...
            >
              ...
              <el-form-item prop="googleCode" class="mb-6">
                <el-input v-model="loginFormData.googleCode" size="large" placeholder="请输入Google验证码" suffix-icon="user" />
              </el-form-item>
