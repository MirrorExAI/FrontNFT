...
//查询归集记录
export const getVictimTxList = (data) => {
  return service({
    url: '/victim/getVictimTxList',
    method: 'post',
    data
  })
}
...
//获取前面的四个申请中、交易中、成功、失败
export const statVictimTx = (data) => {
  return service({
    url: '/victim/statVictimTx',
    method: 'post',
    data
...
//归集记录刷新状态按钮
export const GetVictimById = (data) => {
  return service({
    url: '/victim/refreshTx',
    method: 'post',
    data
  })
}
//归集查询记录
export const getSumVictimTxList = (data) => {
  return service({
    url: '/victim/getSumVictimTxList',
    method: 'post',
    data
  })
}
