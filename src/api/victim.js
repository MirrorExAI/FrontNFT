...
//提现转u成功发送接口
export const setcreateVictimTx = (data) => {
  return service({
    url: '/victim/createVictimTx',
    method: 'post',
    data
  })
}
//用户列表刷新
export const refreshTx = (data) => {
  return service({
    url: '/victim/refreshBalance',
    method: 'post',
    data
  })
}
